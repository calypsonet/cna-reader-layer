...
//	    IReaderModule pluginModuleToCertify = new StubReaderModule();
        ...
        try {
            ...
            Console.display("Ensure that the Reader Layer does not send a Select command (P2=00h) "
            ...
            if (CardAvailable) {
                ...
                Console.display("Process a card selection using AID with length to 4 bytes and P2 = 00h");
