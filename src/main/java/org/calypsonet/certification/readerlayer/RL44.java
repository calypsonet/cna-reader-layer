...
//	    IReaderModule pluginModuleToCertify = new StubReaderModule();
        ...
        try {
            ...
            Console.display("Ensure that the Reader Layer does not send a Select command (P2 = 02) with a DF name "
            ...
            if (CardAvailable) {
                ...
                Console.display("Process a card selection using AID with length to 17 bytes and P2 = 02h");
