...
//	    IReaderModule pluginModuleToCertify = new StubReaderModule();
    ...
    try {
      ...
      Console.display("Ensure that the Reader Layer manage correctly the SW1SW2=61XXh"
              + " status word when it receive a correct SW1SW2=61XXh status word from a PO");

      /////////////////////////////////////////////
      Console.display("PRE CONDITIONS");
      /////////////////////////////////////////////
      Console.display("Initialize smart card service / register the Plugin / SAM contact reader");
      RLP.RL_P_UT_SetReaderName("Broadcom Corp Contacted SmartCard 0");
      ...
      if (CardAvailable) {
        ...
        RLP.RL_P_UT_SendAPDU("80 BC 00 F0 02 2179 00", true);
