...
public class RL46 {
    ...
    private static void Test() {
        ...
        String AID_For_Test =  "315449432E494341FFFFFFFFFFFF0001";
        String FCIValue = "";
        String ErrorMessage = "";
...
//	    IReaderModule pluginModuleToCertify = new StubReaderModule();
        ...
        try {
            ...
            Console.display("Ensure that the Reader Layer send the select command when the DF name is on 16 bytes");
            ...
            if (CardAvailable) {
                ...
                Console.display("Process a card selection using AID with length to 16 bytes ");
